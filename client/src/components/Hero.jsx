    ...
    return (
        <div className="relative isolate overflow-hidden bg-gradient-to-r from-pink-100 to-pink-300 z-0">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
                ...
                <h1 className="font-twinkle mt-10 text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl slide-in-left">
                    Where every drink tells a story and every sip is your adventure!
                </h1>
                <p className="font-gamja mt-6 text-2xl leading-8 text-black slide-in-left-2">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                    <a
                    href="#drink-menu"
                    className="font-gamja text-2xl rounded-md bg-indigo-600 px-3.5 py-2.5 font-semibold text-white hover:bg-indigo-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-00 slide-in-left-2"
                    >
                    Order Now
                    </a>
                </div>
                ...
                <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32 slide-in-right">
                    <div className="mx-auto mt-16 flex max-w-lg sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:flex-none xl:ml-32">
                        <div className="relative rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:p-4">
                            <img
                                ...
                                className="w-full h-full object-cover object-center rounded-md shadow-2xl ring-1 ring-gray-900/10"
                                style={{ WebkitUserDrag: 'none', userDrag: 'none', width: '100%', height: '100%' }}
                            />
                        </div>
                    </div>
                </div>
